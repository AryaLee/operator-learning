...
import (
	...
	"AryaLee/operator-learning/controllers"
...
func init() {
	...
	utilruntime.Must(sdnv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1afe5350.github.com",
	...
	if err = (&sdnv1.Vpc{}).SetupWebhookWithManager(mgr); err != nil {
	...
	if err = (&sdnv1.Subnet{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "Subnet")
		os.Exit(1)
	}
	if err = (&controllers.VniReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
